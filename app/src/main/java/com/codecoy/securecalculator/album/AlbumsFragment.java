...
import com.codecoy.securecalculator.activities.SplashScreen;
...
//        addNewFolder();
    ...
    public void setadapter() {
         ...
         adapter = new AlbumsAdapter(name_list,quantity_list,image_resource,image_background,requireContext());
        ...
        pictureFloatingButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (LoadAds.getInstance(getContext()).isFacebookInterstitialLoaded()) {
                    ...
                    CharSequence[] cs = name_list.toArray(new CharSequence[name_list.size()]);
                    AlertDialog.Builder alt_bld = new AlertDialog.Builder(requireContext());
                    //alt_bld.setIcon(R.drawable.icon);
                    alt_bld.setTitle("Select a folder Name");
                    alt_bld.setSingleChoiceItems(cs, -1, new DialogInterface
                            .OnClickListener() {
                        public void onClick(DialogInterface dialog, int item) {
                            startActivityForResult(new Intent(requireContext(), AddImageActivity.class).putExtra("folder_name",cs[item]), 1012);
            ...
            public void onClick(View v) {
                ...
                if (LoadAds.getInstance(getContext()).isFacebookInterstitialLoaded()) {
                    ...
                    alt_bld.setSingleChoiceItems(cs, -1, new DialogInterface
                            .OnClickListener() {
                        public void onClick(DialogInterface dialog, int item) {
                            startActivityForResult(new Intent(requireContext(), AddAudiosActivity.class).putExtra("folder_name",cs[item]), 1012);
                            dialog.dismiss();// dismiss the alertbox after chose option
            ...
            public void onClick(View v) {
                ...
                if (LoadAds.getInstance(getContext()).isFacebookInterstitialLoaded()) {
                    ...
                    alt_bld.setSingleChoiceItems(cs, -1, new DialogInterface
                            .OnClickListener() {
                        public void onClick(DialogInterface dialog, int item) {
                            startActivityForResult(new Intent(requireContext(), AddVideoActivity.class).putExtra("folder_name",cs[item]), 1012);
                            dialog.dismiss();// dismiss the alertbox after chose option
            ...
            public void onClick(View v) {
                if (LoadAds.getInstance(getContext()).isFacebookInterstitialLoaded()) {
                    ...
                    alt_bld.setSingleChoiceItems(cs, -1, new DialogInterface
                            .OnClickListener() {
                        public void onClick(DialogInterface dialog, int item) {
                            startActivityForResult(new Intent(requireContext(), FileSelectionActivity.class).putExtra("folder_name",cs[item]), 1012);
                            dialog.dismiss();// dismiss the alertbox after chose option
