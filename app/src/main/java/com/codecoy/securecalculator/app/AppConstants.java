...
public class AppConstants {
    ...
    public static final String IMAGE_EXPORT_PATH = (Environment.getExternalStorageDirectory() + File.separator + EXPORT_FOLDER + File.separator);
    public static final String IMAGE_PATH = (Environment.getExternalStorageDirectory() + File.separator + HIDDEN_FOLDER + File.separator );
