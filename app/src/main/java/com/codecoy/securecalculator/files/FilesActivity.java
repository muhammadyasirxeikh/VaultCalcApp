package com.codecoy.securecalculator.files;
...
import com.codecoy.securecalculator.files.adapter.FilesAdapter;
...
public class FilesActivity extends BaseActivity implements OnFilesLoadedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoadAds.getInstance(FilesActivity.this).loadFacebookNativeBanner(FilesActivity.this, native_banner);
    ...
    private void setHeaderInfo() {
        ...
        name_video.setText("Files");
        image_video.setImageResource(R.drawable.ic_baseline_folder_24_white);
        toolbar.setTitleTextColor(getResources().getColor(R.color.white));
        getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#ffffff\">" + getString(R.string.file) + "</font>")));
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.fab_add:
                ...
                if (LoadAds.getInstance(FilesActivity.this).isFacebookInterstitialLoaded()) {
                    LoadAds.getInstance(FilesActivity.this).showFacebookInterstital();
                    LoadAds.getInstance(FilesActivity.this).setOnFacebookInterstitialAdclosedListner(new InterstitialAdListener() {
                        @Override
                        ...
                        public void onInterstitialDismissed(Ad ad) {
                            ...
                            LoadAds.getInstance(FilesActivity.this).reloadfacebookInterstitial();
                            startActivityForResult(new Intent(FilesActivity.this, FileSelectionActivity.class), 1012);
                ...
                public void onInterstitialDismissed(Ad ad) {
                    ...
                    if (adapter != null) {
                        ...
                        if (selectedFiles == null || selectedFiles.size() <= 0) {
                            Toast.makeText(FilesActivity.this, "Please select at least one image!", 0).show();
                            return;
                        }
