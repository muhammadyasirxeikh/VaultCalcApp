...
import com.codecoy.securecalculator.common.MergeAdapter;
...
public class FileSelectionActivity extends BaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        LoadAds.getInstance(FileSelectionActivity.this).loadFacebookNativeBanner(FileSelectionActivity.this, native_banner);
    ...
    private void setHeaderInfo() {
        ...
        getSupportActionBar().setTitle((Html.fromHtml("<font color=\"#17181A\">" + getString(R.string.select_file) + "</font>")));
    ...
    public void ok() {
        ...
        if (LoadAds.getInstance(FileSelectionActivity.this).isFacebookInterstitialLoaded()) {
            LoadAds.getInstance(FileSelectionActivity.this).showFacebookInterstital();
            LoadAds.getInstance(FileSelectionActivity.this).setOnFacebookInterstitialAdclosedListner(new InterstitialAdListener() {
                @Override
                ...
                public void onInterstitialDismissed(Ad ad) {
                    ...
                    LoadAds.getInstance(FileSelectionActivity.this).reloadfacebookInterstitial();
                    ...
                    if (selectedFiles == null || selectedFiles.size() <= 0) {
                        Toast.makeText(FileSelectionActivity.this, "Please select at least one file!", 0).show();
                        return;
                    }
